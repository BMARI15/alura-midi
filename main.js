    alert ('Essa página contem vírus');
...
function tocaSomSplah(){document.querySelector('#som_tecla_splash').play();}
    document.querySelector('.tecla_splash') .onclick =tocaSomSplah;
